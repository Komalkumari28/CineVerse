...
const Movies = () => {
  ...
  return (
    <div className="movies-page bg-dark py-5 min-vh-100">
      <div className="container mt-4">
        <div className="d-flex align-items-center justify-content-between mb-4">
          <h2 className="text-white fw-bold">Explore <span className="text-gradient">Movies</span></h2>
          <span className="text-secondary small">{items.length} titles found</span>
        </div>
